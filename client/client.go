...
const CLIENT_ID = 2
const CLIENT_DESC = "This is a Go Protobuf client!!"

func main() {
	filename := flag.String("f", "/Users/Park-jihun/Desktop/1_BlockChain/4_Program/0_GoLang/workspace/src/github.com/alexjipark/ds_rpc_server/client/CSVV.csv", "Enter the filename to read from")
	dest := flag.String("d", "127.0.0.1:2110", "Enter the desnation socket address")
	flag.Parse()
...
func retrieveDataFromFile(fname *string) ([]byte, error) {
	...
	ProtoMessage.Description = proto.String(CLIENT_DESC)
